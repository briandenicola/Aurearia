---
name: module-level-state-management
description: "Prevent Vue composable state leaking across component lifecycles and navigation."
---
...
- Constitution Principle III: Strict Types and Explicit Contracts

Use authorized `task check:web` for completion, including zero-warning lint and
full package tests. A Pinia store does not automatically reset on unmount:
preserve an explicit ownership/reset contract and test navigation away and back.
