...
type FeaturedCoinSourceType string

const (
	FeaturedCoinSourceOwned    FeaturedCoinSourceType = "owned"
	FeaturedCoinSourceWishlist FeaturedCoinSourceType = "wishlist"
)
...
type FeaturedCoin struct {
	...
	SourceType FeaturedCoinSourceType `gorm:"type:varchar(16);not null;default:'owned'" json:"sourceType"`
