    ...
    <form @submit.prevent="$emit('save')">
      ...
      <template v-if="settings.AIProvider === 'anthropic'">
        ...
        <div class="connectivity-actions">
          <button type="button" class="btn btn-secondary btn-sm" :disabled="anthropicTesting" @click="$emit('test-anthropic')">
      ...
      <template v-if="settings.AIProvider === 'ollama'">
        ...
        <div class="connectivity-actions">
          <button type="button" class="btn btn-secondary btn-sm" :disabled="ollamaTesting" @click="$emit('test-ollama')">
            {{ ollamaTesting ? 'Testing...' : 'Test Ollama' }}
          </button>
          <button v-if="settings.SearXNGURL" type="button" class="btn btn-secondary btn-sm" :disabled="searxngTesting" @click="$emit('test-searxng')">
